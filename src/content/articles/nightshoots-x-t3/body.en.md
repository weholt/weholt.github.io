### Nightshoots with X-T3 and XF 56mm f/1.2

*In this post, I briefly touch on the problems using the [XF 56mm f/1.2](https://fujifilm-x.com/global/products/lenses/xf56mmf12-r/) in low light scenarios. The cover ph*oto was taken using this lens at 1/125s, 2500 ISO — wide open.

Before I even got deep into the Fujiverse I was intrigued by the [Fujinon XF 56mm f/1.2](https://fujifilm-x.com/global/products/lenses/xf56mmf12-r/) — the magic lens from Fuji. Previously I used Sony A7II for a brief period and bought the Sony FE 85mm f/1.8 which for me was a terrific lens with great bokeh. The 56mm f/1.2 was Fuji’s closest alternative and soon made it into my list of wanted gear.

The XF56mm had three major selling points:

1. The 85mm focal length in full-frame terms is good for portraits
1. It’s the widest aperture lens Fuji has to offer & good for low light
1. It has that special bokeh people love
...
![](/images/medium/nightshoots-x-t3/image-001.jpg)
...
![](/images/medium/nightshoots-x-t3/image-002.jpg)

**Noise**

![](/images/medium/nightshoots-x-t3/image-003.jpg)
...
![](/images/medium/nightshoots-x-t3/image-004.jpg)

![](/images/medium/nightshoots-x-t3/image-005.jpg)
...
![](/images/medium/nightshoots-x-t3/image-006.jpg)
...
Because of the high price tag of the 56mm, I bought the [Fujicron 50mm f/2](https://fujifilm-x.com/global/products/lenses/xf50mmf2-r-wr/) many months before the 56mm and had already fallen in love with that little lens and the approx 75mm focal length it provides. After reviewing my photos from the previous night I thought it would be fun to see how the little 50mm f/2 would perform under similar conditions, so we went back, down to the river (play some Springsteen right about now) with the X-T3.

![](/images/medium/nightshoots-x-t3/image-007.jpg)
...
![](/images/medium/nightshoots-x-t3/image-008.jpg)

![](/images/medium/nightshoots-x-t3/image-009.jpg)
...
![](/images/medium/nightshoots-x-t3/image-011.jpg)

**In conclusion**

First of all, I need more experience shooting under such conditions and if I were to choose right now between the XF 56mm f/1.2 or the XF 50mm f/2 I’d probably still take the XF 56mm, but it’s close. I love the bokeh, but the auto-focus is making me frustrated and the whole photography experience suffers. And even the small focus area available when using the lens wide open is problematic and as mentioned, I lost a lot of otherwise usable shots because the camera didn’t manage to keep up. Fujifilm will release the much anticipated [Fujinon XF 50mm f/1.0](https://www.fujirumors.com/leaked-fujinon-xf-50mm-f-1-0-press-text-worlds-first-f1-0-autofocus-mirrorless-lens/) in the [near future](https://www.fujirumors.com/breaking-fujinon-xf-50mm-f-1-0-announcement-on-september-3-and-cost-1500/), and will hopefully have autofocus performance on par with the XF 50mm f/2, but it will be expensive, heavy and big. Will it solve the low light needs for us Fujiboys?

What are your tips for nighttime photography? What settings do you use and how do you manage noise in post-processing?

**Further reading**

- Fujifilm.com : [Reducing Noise in Low Light Images](https://fujifilm-x.com/en-us/stories/intermediate-month-6-low-light-22-noise-reduction?utm_medium=Weekly%20Intermediate%2022&utm_source=adestra&utm_campaign=weekly_educational_email_journey)
- [A review of Topaz Labs DeNoise AI](https://shotkit.com/topaz-denoise-ai-review/)
- [Noise reduction in Capture One](https://support.captureone.com/hc/en-us/articles/360002615758-Noise-Reduction)
- [Use Layers to Apply Noise Reduction to the Shadows in Capture One](https://blog.thomasfitzgeraldphotography.com/blog/2019/8/use-layers-to-apply-noise-reduction-to-the-shadows-in-capture-one)
- [Removing noise with Noise Reduction in Capture One](http://alexonraw.com/removing-noise-with-noise-reduction-in-capture-one/)
